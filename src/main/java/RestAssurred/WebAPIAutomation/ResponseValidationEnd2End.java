...
public class ResponseValidationEnd2End {

	@Test
	public void verifyResponse() {

		String requestBody = "{" + "\"location\": { " + "\"lat\": -33.866971123445," + "\"lng\": 151.1958750" + "},"
		...
		Response res = given().queryParam("key", "AIzaSyB-ZliaFkPtyfykn7E2nW2yxgBPAvRVUMo").body(requestBody).when()
		...
		given().queryParam("key", "AIzaSyB-ZliaFkPtyfykn7E2nW2yxgBPAvRVUMo")
				.body("{" + "\"place_id\": \"" + placeId + "\"" + "}").when().post("/maps/api/place/delete/json").
